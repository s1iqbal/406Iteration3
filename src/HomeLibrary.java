...
public class HomeLibrary extends Database {
	...
	private void initialize() {
		...
		JTextPane officialDescription = new JTextPane();
		officialDescription.setEditable(false);
		officialDescription.setFont(new Font("Tahoma", Font.BOLD, 15));
		officialDescription.setBackground(SystemColor.control);
		officialDescription.setBounds(130, 50, 662, 500);
		officialDescription.setText("Select which official you would like to contact below:");

		JButton official1 = new JButton("Amit R");
		official1.setBounds(270, 113, 89, 23);

		JButton official2 = new JButton("Saad I");
		official2.setBounds(270, 213, 89, 23);

		JButton official3 = new JButton("Gianluca M");
		official3.setBounds(268, 313, 99, 23);

		JPanel official1Panel = new JPanel();
		official1Panel.setBounds(0, 0, 694, 421);
		frmLibraryManagingSystem.getContentPane().add(official1Panel);
		official1Panel.setLayout(null);
		official1Panel.setVisible(false);
		JTextPane amitText = new JTextPane();
		amitText.setEditable(false);
		amitText.setFont(new Font("Tahoma", Font.BOLD, 15));
		amitText.setBackground(SystemColor.control);
		amitText.setText("Amit Rambaran\n" + "416-967-1111\n" + "Office Hours: Tuesdays 4-6");
		amitText.setBounds(20, 50, 662, 500);
		official1Panel.add(amitText);

		JPanel official2Panel = new JPanel();
		official2Panel.setBounds(0, 0, 694, 421);
		frmLibraryManagingSystem.getContentPane().add(official2Panel);
		official2Panel.setLayout(null);
		official2Panel.setVisible(false);
		JTextPane saadText = new JTextPane();
		saadText.setEditable(false);
		saadText.setFont(new Font("Tahoma", Font.BOLD, 15));
		saadText.setBackground(SystemColor.control);
		saadText.setText("YOUR DESIRED TEXT");
		saadText.setBounds(20, 50, 662, 500);
		official2Panel.add(saadText);

		JPanel official3Panel = new JPanel();
		official3Panel.setBounds(0, 0, 694, 421);
		frmLibraryManagingSystem.getContentPane().add(official3Panel);
		official3Panel.setLayout(null);
		official3Panel.setVisible(false);
		JTextPane gianlucaText = new JTextPane();
		gianlucaText.setEditable(false);
		gianlucaText.setFont(new Font("Tahoma", Font.BOLD, 15));
		gianlucaText.setBackground(SystemColor.control);
		gianlucaText.setText("YOUR DESIRED TEXT 2");
		gianlucaText.setBounds(20, 50, 662, 500);
		official3Panel.add(gianlucaText);

		contactPanel.add(official1);
		contactPanel.add(official2);
		contactPanel.add(official3);
		contactPanel.add(officialDescription);

		official1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				contactPanel.setVisible(false);
				official1Panel.setVisible(true);

			}
		});

		official2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				contactPanel.setVisible(false);
				official2Panel.setVisible(true);
			}
		});

		official3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				contactPanel.setVisible(false);
				official3Panel.setVisible(true);
			}
		});
		...
		friendPanel.setBounds(0, 0, 694, 421);
		frmLibraryManagingSystem.getContentPane().add(friendPanel);
		friendPanel.setLayout(null);
		friendPanel.setVisible(false);

		JTextField friendEmail = new JTextField();
		friendEmail.setColumns(10);
		friendEmail.setBounds(180, 180, 200, 20);

		JTextField friendMessage = new JTextField();
		friendMessage.setColumns(20);
		friendMessage.setBounds(100, 250, 541, 100);
		TextPrompt ghostText = new TextPrompt(
				"**SENT BY DEFAULT** " + "Hey! " + "Check out Cypress, a new way to report problems in the city!",
				friendMessage);

		JTextPane friendTitle = new JTextPane();
		friendTitle.setEditable(false);
		friendTitle.setFont(new Font("Tahoma", Font.BOLD, 15));
		friendTitle.setBackground(SystemColor.control);
		friendTitle
				.setText("Enter your friend's email to tell him about this \nservice, as well as an optional message!");
		friendTitle.setBounds(130, 100, 450, 300);

		friendPanel.add(friendTitle);
		friendPanel.add(friendEmail);
		friendPanel.add(friendMessage);
		// WHY WONT YOU TAKE
		// TEXTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT

		JButton sendInput = new JButton("Send");
		sendInput.setBounds(600, 360, 80, 23);

		friendPanel.add(sendInput);

		sendInput.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String enteredEmail = friendEmail.getText();
				String from = "cypress.on.gov.ca";
				String host = "localhost";
				Properties properties = System.getProperties();
				properties.setProperty("mail.smtp.host", host);
				// actual implementation requires user/password, host account,
				// etc
			}
		});
		// frmLibraryManagingSystem.setBounds(100, 100, 700, 450);
		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				addProfile(textField_firstName.getText(), textField_lastName.getText(), textField_Address.getText(),
						textField_Phone1.getText() + textField_Phone2.getText() + textField_Phone3.getText(),
		...
		btnRegisterCI.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				editProfile(textField_firstNameCI.getText(), textField_lastNameCI.getText(),
						textField_AddressCI.getText(),
						textField_Phone1CI.getText() + textField_Phone2CI.getText() + textField_Phone3CI.getText(),
						textField_EmailCI.getText(), textField_UsernameCI.getText(), textField_PasswordCI.getText());
		...
		final JRadioButton rdbtnTellAFriend = new JRadioButton("Tell a friend");
		...
		myButtonGroup.add(rdbtnTellAFriend);
		...
		rdbtnTellAFriend.setBounds(26, 330, 109, 23);
		portalPanel.add(rdbtnTellAFriend);
		...
		btnO.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (rdbtnReport.isSelected()) {
					...
					portalPanel.setVisible(false);
				} else if (rdbtnTellAFriend.isSelected()) {
					portalPanel.setVisible(false);
		...
		EnterLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String pass = new String(passwordField.getPassword()); // hidden
																		// for
																		// security
																		// reasons
				...
				for (Profile profiles : storage) {
					if (profiles.Username.equals(username) && profiles.password.equals(pass)) {
						...
						// errormessage.setText("Please Enter the correct login
						// information");
		...
		txtpnYouAreCurrently.setText(
				"You are currently at the Cypress Login Page. By logging into this system, you will be able to report a variety of problems as you have witnessed on the streets of Toronto.");
